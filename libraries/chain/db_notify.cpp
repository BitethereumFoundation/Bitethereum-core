...
struct get_impacted_account_visitor
{
   ...
   void operator()( const airdrop_balance_claim_operation& op ) {_impacted.insert(op.account_to_deposit);}
   void operator()( const airdrop_end_operation& op ) {_impacted.insert(op.issuer);}
